...
public class RedSideFar extends OpMode {
    ...
    private final Pose outtakePre = new Pose(90,16,Math.toRadians(90));
    ...
    private final Pose end = new Pose(110,5,Math.toRadians(0));
    ...
    public void buildPaths(){
        ...
        End = follower.pathBuilder()
                .addPath(new BezierLine(outtakePre,end)) //outtake
                .setConstantHeadingInterpolation(0)
                .build();
    }
