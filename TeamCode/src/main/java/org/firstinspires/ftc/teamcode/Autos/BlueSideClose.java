...
public class BlueSideClose extends OpMode {
    ...
    private final Pose outtakePre = new Pose(144-98,90,Math.toRadians(180-41));
    ...
    private final Pose intake2p2 = new Pose(144-132,68-5,Math.toRadians(180));
