...
public class RedFarGate extends OpMode {
    ...
    //positions
    private final Pose start = new Pose(90, 0, Math.toRadians(0)); // staring postition
    private final Pose outtakePre = new Pose(90, 10, Math.toRadians(0)); // moving out to shoot preload
    ...
    // since balls will prob not be directly at wall, will intake a bit further up in the zone
    private final Pose preintake2 = new Pose(120, 8, Math.toRadians(90));// need to align because doesnt curve
    private final Pose intake2 = new Pose(138, 3, Math.toRadians(90)); // intaking the batch @ loading
    ...
    public void statePathUpdate() {
        ...
        switch (pathState) {
            ...
            case SHOOT1:
                ...
                break;
            case ALIGNINTAKE2:
                move(Intake21, PathState.WAIT);
                break;
            case WAIT:
                wait(500,PathState.INTAKE2);
            case INTAKE2:
    ...
    public void wait(int milliseconds, PathState nextPath){
