...
public class RedFar extends OpMode {
    ...
    //positions
    private final Pose start = new Pose(90, 0, Math.toRadians(90)); // staring postition
    private final Pose outtakePre = new Pose(90, 10, Math.toRadians(90)); // moving out to shoot preload
    private final Pose outtake = new Pose(90, 10, Math.toRadians(0));  // general position to shoot after getting preload

    private final Pose preintake1 = new Pose(90, 30, Math.toRadians(0));// need to align because doesnt curve
    // test bezier curve later.

    private final Pose intake1 = new Pose(120, 35, Math.toRadians(0)); // intaking the first batch
    ...
    private final Pose end = new Pose(100, 18, Math.toRadians(0));
