...
public class BlueClose extends OpMode {
    ...
    //positions
    private final Pose start = new Pose(15, 130, Math.toRadians(139));
    private final Pose outtakePre = new Pose(60, 90, Math.toRadians(139));
    private final Pose outtake = new Pose(65, 90, Math.toRadians(0));
    private final Pose intake1 = new Pose(35, 88, Math.toRadians(0));
    private final Pose intake2p1 = new Pose(60, 68, Math.toRadians(0));
    private final Pose intake2p2 = new Pose(60, 68, Math.toRadians(0));
    private final Pose end = new Pose(20, 90, Math.toRadians(0));
    ...
    public void statePathUpdate() {
        ...
        switch (pathState) {
            case PRELOAD:
                ...
                break;
            case SHOOTPRE:
                shoot(1000,1000, PathState.INTAKE1);
                break;
            case INTAKE1:
